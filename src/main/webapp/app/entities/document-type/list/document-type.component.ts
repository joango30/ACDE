...
import { EntityArrayResponseType, DocumentTypeService } from '../service/document-type.service';
import { DocumentTypeDeleteDialogComponent } from '../delete/document-type-delete-dialog.component';

@Component({
  selector: 'acde-document-type',
...
export class DocumentTypeComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDocumentType): number => this.documentTypeService.getDocumentTypeIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.documentTypes = dataFromBody;
  }
