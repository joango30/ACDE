package co.edu.acde.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import co.edu.acde.IntegrationTest;
import co.edu.acde.repository.timezone.DateTimeWrapper;
import co.edu.acde.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM acde_date_time_wrapper where id=%d", fieldName, id);
    }
