...
import co.edu.acde.repository.DocumentTypeRepository;
import co.edu.acde.service.dto.DocumentTypeDTO;
import co.edu.acde.service.mapper.DocumentTypeMapper;
...
class DocumentTypeResourceIT {
    ...
    public static DocumentType createEntity(EntityManager em) {
        DocumentType documentType = new DocumentType().initials(DEFAULT_INITIALS).documentName(DEFAULT_DOCUMENT_NAME);
        return documentType;
    }
    ...
    public static DocumentType createUpdatedEntity(EntityManager em) {
        DocumentType documentType = new DocumentType().initials(UPDATED_INITIALS).documentName(UPDATED_DOCUMENT_NAME);
        return documentType;
    }
    ...
    void putExistingDocumentType() throws Exception {
        ...
        updatedDocumentType.initials(UPDATED_INITIALS).documentName(UPDATED_DOCUMENT_NAME);
    ...
    void fullUpdateDocumentTypeWithPatch() throws Exception {
        ...
        partialUpdatedDocumentType.initials(UPDATED_INITIALS).documentName(UPDATED_DOCUMENT_NAME);
