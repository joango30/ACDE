...
import co.edu.acde.repository.EmployeeRepository;
import co.edu.acde.service.EmployeeService;
import co.edu.acde.service.dto.EmployeeDTO;
import co.edu.acde.service.mapper.EmployeeMapper;
...
class EmployeeResourceIT {
    ...
    private static final State DEFAULT_STATUS = State.TRAINED;
    private static final State UPDATED_STATUS = State.NOTTRAINED;
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getCharge()).isEqualTo(DEFAULT_CHARGE);
    ...
    @Test
    @Transactional
    void checkChargeIsRequired() throws Exception {
        int databaseSizeBeforeTest = employeeRepository.findAll().size();
        // set the field null
    ...
    void putExistingEmployee() throws Exception {
        ...
        updatedEmployee.status(UPDATED_STATUS).charge(UPDATED_CHARGE).email(UPDATED_EMAIL).phoneNumber(UPDATED_PHONE_NUMBER);
        ...
        assertThat(testEmployee.getCharge()).isEqualTo(UPDATED_CHARGE);
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.charge(UPDATED_CHARGE).email(UPDATED_EMAIL);
    ...
    void fullUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.status(UPDATED_STATUS).charge(UPDATED_CHARGE).email(UPDATED_EMAIL).phoneNumber(UPDATED_PHONE_NUMBER);
